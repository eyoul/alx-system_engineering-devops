0.Write a script that prints “Hello, World”, followed by a new line to the standard output.1.Display the content of the /etc/passwd file.2.Display the content of /etc/passwd and /etc/hosts3.Display the last 10 lines of /etc/passwd
